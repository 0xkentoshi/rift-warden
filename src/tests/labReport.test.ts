...
describe('laboratory report', () => {
  it('calculates current portal summary', () => {
    const report = calculateLabReport(initialPortals, [])
  ...
  it('counts successful and rejected actions', () => {
    ...
    const events = [
      createAuditEvent(portal, 'stabilize', risk, 38, {
        id: 'one',
        timestamp: '2026-09-18T10:00:00.000Z',
      }),
      createAuditEvent(portal, 'observe', risk, risk, {
        id: 'two',
    ...
    const report = calculateLabReport(initialPortals, events)
